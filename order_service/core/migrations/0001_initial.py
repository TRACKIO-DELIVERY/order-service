# Generated by Django 5.1.9 on 2025-05-22 16:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('Waiting for Collection', 'Aguardando Coleta'), ('En Route', 'Em Rota'), ('Delivered', 'Entregue'), ('Cancelled', 'Cancelado'), ('In Production', 'Em Produção')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_delivery_address', models.CharField(max_length=400)),
                ('pickup_street', models.CharField(max_length=100)),
                ('pickup_neighborhood', models.CharField(blank=True, max_length=100)),
                ...
                ('full_pickup_address', models.CharField(max_length=400)),
