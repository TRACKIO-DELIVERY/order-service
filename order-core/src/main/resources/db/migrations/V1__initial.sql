...
ALTER TABLE order_item
    ADD CONSTRAINT FK_ORDERITEM_ON_ORDER FOREIGN KEY (order_id) REFERENCES "purchase_order" (id);

ALTER TABLE order_item
    ADD CONSTRAINT FK_ORDERITEM_ON_PRODUCT_ID_PRODUCT FOREIGN KEY (product_id_product) REFERENCES product (id_product);

ALTER TABLE order_log
    ADD CONSTRAINT FK_ORDERLOG_ON_ORDER FOREIGN KEY (order_id) REFERENCES "purchase_order" (id);
...
ALTER TABLE payment
    ADD CONSTRAINT FK_PAYMENT_ON_ORDER FOREIGN KEY (order_id) REFERENCES "purchase_order" (id);
